...
while ($row = mysqli_fetch_array($result)) {
	...
	$gas = $gas . '"'. $row['gas'] .'",';
	$time_update = $time_update . '"'. $row['time_update'] .'",';
}

$temperature = trim($temperature,",");
$humidity = trim($humidity,","); 
$gas = trim($gas,","); 
$time_update = trim($time_update,","); 
...
<html>
    ...
    <div class="column">
       ...
       <div class="column">
        <div class="chart-container3" style="height:20vh; width:40vw">
            <h1>Gas</h1>  
            <canvas id="myChart3" style=" height: 65vh; background: #FEFEFE; border: 1px solid #555652; margin-top: 10px;"></canvas>
        </div>
    </div>
    </div>
	<script>
